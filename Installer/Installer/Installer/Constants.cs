namespace Installer
{
    public static class Constants
    {
        ...
        public const string REGISTRY_PATH = @"Installer";
        ...
        public const string WARNING_CAPTION = "Warning";
        public const string INFO_CAPTION = "Info";
        ...
        public const string MESSAGE_NO_UPDATES = "The downloaded files are up-to-date.";
    }
}
